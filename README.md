...
1. **Clone the repository**
   ...
   cd BaseCleanAchitectureNoneDDD
   ```
...
یک تمپلیت جامع و آماده تولید با معماری تمیز که با .NET 8 ساخته شده و شامل روش‌های توسعه مدرن و راه‌حل‌های سطح سازمانی است.

## 🏗️ نمای کلی معماری

این تمپلیت اصول معماری تمیز را با جداسازی واضح نگرانی‌ها در چندین لایه پیاده‌سازی می‌کند:
